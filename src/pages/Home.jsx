        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10'>
          <div className='mx-auto max-w-4xl space-y-8'>
            <h1 className='text-6xl md:text-8xl font-bold tracking-tighter text-brand-text-primary leading-[0.9] md:leading-[0.9]'>
              ...
              <DoodleHighlight type='underline' color='#6B7280'>
                Anywhere
              </DoodleHighlight>{" "}
              on campus.
            </h1>
      ...
      <section className='bg-section-bg py-24 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-20'>
            <h2 className='text-3xl md:text-4xl font-bold tracking-tight text-brand-text-primary'>
              Why DocDash?
            </h2>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            ...
            <div className='group bg-card-bg hover:bg-card-hover rounded-3xl p-10 transition-colors duration-300'>
              ...
              <p className='text-brand-text-body leading-relaxed'>
                Automatically finding the optimized route for your print job
                based on real-time location and queue status.
              </p>
            </div>
            ...
            <div className='group bg-card-bg hover:bg-card-hover rounded-3xl p-10 transition-colors duration-300'>
              ...
              <p className='text-brand-text-body leading-relaxed'>
                Real-time updates on your document status. Know exactly when
                your files are printed and ready for pickup.
              </p>
            </div>
            ...
            <div className='group bg-card-bg hover:bg-card-hover rounded-3xl p-10 transition-colors duration-300'>
              ...
              <p className='text-brand-text-body leading-relaxed'>
                Seamless and secure payments via UPI or Cards. Experience a
                cashless workflow designed for users.
              </p>
            </div>
          </div>
        </div>
