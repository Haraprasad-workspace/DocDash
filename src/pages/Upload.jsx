              ...
              {shops.map((shop) => (
                ...
                >
                  ...
                  <div className='flex-1'>
                    <h3 className='font-bold text-brand-text-primary text-xl tracking-tight'>
                      {shop.name}
                    </h3>
                    <div className='flex items-center gap-6 mt-2 text-sm text-brand-text-muted font-medium'>
                      <span className='flex items-center gap-1.5'>
                        <svg
                          className='w-4 h-4 text-brand-text-disabled'
                          fill='none'
                          viewBox='0 0 24 24'
                          stroke='currentColor'
                        >
                  ...
                  <div className='text-right'>
                    <span className='block text-2xl font-bold text-brand-text-primary'>
                      ₹{shop.totalPrice}
                    </span>
                    <span className='text-xs text-brand-text-disabled font-medium'>
                      Est. Total
                    </span>
                  </div>
                </label>
